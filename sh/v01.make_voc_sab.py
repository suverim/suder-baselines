...
metafile = '../data/sabah/meta_sabah.csv'
jsonfile = '../data/sabah/texts_sabah.json'

outvocabtextfile = '../data/sabah/vocab01.txt'
outvocabpicklefile = '../data/sabah/vocab01.pickle'
